...
(function() {
  ...
  var modalHTML = '<div id="cookieModal" style="display:none;position:fixed;inset:0;z-index:4000;background:rgba(30,20,10,.52);backdrop-filter:blur(4px);align-items:center;justify-content:center;padding:24px;">'
    ...
    + '<div style="font-size:12px;color:#8A7A6E;line-height:1.5;">Required for the site to function. Cart, session, and your cookie preferences.</div></div></label>'
    ...
    + '<div style="font-size:12px;color:#8A7A6E;line-height:1.5;">Help us understand how visitors use the site so we can improve it.</div></div></label>'
    + '<label style="display:flex;align-items:flex-start;gap:14px;padding:16px;background:#F5F0E8;border:1px solid #EDE5D8;border-radius:8px;cursor:pointer;">'
    ...
    + '<div style="font-size:12px;color:#8A7A6E;line-height:1.5;">Remember your preferences for a tailored experience.</div></div></label>'
    + '</div>'
